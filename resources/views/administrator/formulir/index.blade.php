    ...
    <table class="table">
        ...
        @foreach($formulirPendaftaran as $formulir)
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('formulir-pendaftaran.show', $formulir->id) }}" class="btn btn-info">Show</a>
                        <a href="{{ route('formulir-pendaftaran.edit', $formulir->id) }}" class="btn btn-primary">Edit</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
